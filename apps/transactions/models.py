...
from apps.accounts.models import Company, CustomUser, MoneySaver
...
class Transaction(models.Model):
    ...
    double_entry_accounting = models.IntegerField(
        _("Pul yo'nalishi"),
    ...
    company_balance = models.DecimalField(
        _("Korxona balansi"), max_digits=20, decimal_places=2, default=0
    )
