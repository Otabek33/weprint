...
from apps.products.views.binding_type_views import binding_type_list, binding_type_add, binding_type_delete,binding_type_update
...
urlpatterns = [
    ...
    path("<int:pk>/binding-type-delete/", binding_type_delete, name="binding_type_delete"),
    path("<int:pk>/binding-type-update/", binding_type_update, name="binding_type_update")
]
